...
router.post('/findPlayerInjury', auth, findPlayerInjury)
router.post('/updatePlayerInjury', auth, updatePlayerInjury)
router.post('/deletePlayerInjury', auth, deletePlayerInjury)
